...
const (
	...
	PROP_IpGlobal_ADDRESS                               = 407
	PROP_IpMode                                         = 408
	PROP_IpMulticast_ADDRESS                            = 409
	PROP_IpNat_TRAVERSAL                                = 410
	...
	PROP_Ipv6Udp_PORT                                   = 438
	PROP_IPV6_DEFAULT_GATEWAY                           = 439
	PROP_Ipv6Multicast_ADDRESS                          = 440
...
const (
	EVENT_LOW_LIMIT_ENABLE  LimitEnable = 1
	EVENT_HIGH_LIMIT_ENABLE             = 2
)

type LimitEnable = uint32

const (
	ACTION_DIRECT  Action = 0
	ACTION_REVERSE        = 1
)
...
const (
	ACTION_BINARY_PV ActionValueType = 0
	ACTION_UNSIGNED                  = 1
	ACTION_FLOAT                     = 2
)

type ActionValueType = uint32

const (
	EVENT_STATE_NORMAL     EventState = 0
	EVENT_STATE_FAULT                 = 1
...
const (
	EVENT_ENABLE_TO_OFFNORMAL EventEnable = 1
	EVENT_ENABLE_TO_FAULT                 = 2
	EVENT_ENABLE_TO_NORMAL                = 4
)

type EventEnable = uint32

const (
	STATUS_OPERATIONAL           DeviceStatus = 0
...
const (
	UNITS_METERS_PER_SECOND_PER_SECOND           EngineeringUnits = 166
...
const (
	POLARITY_NORMAL  BACNET_POLARITY = 0
	POLARITY_REVERSE                 = 1
	MAX_POLARITY                     = 2
)

type BACNET_POLARITY = uint32

const (
	PROGRAM_REQUEST_READY   ProgramRequest = 0
...
type ProgramRequest = uint32

const (
	PROGRAM_STATE_IDLE      ProgramState = 0
...
const (
	PROGRAM_ERROR_NORMAL          ProgramError = 0
...
const (
	RESTART_REASON_UNKNOWN             RestartReason = 0
...
const (
	PROP_STATE_BOOLEAN_VALUE              PropertyStates = 0
...
type PropertyStates = uint32

const (
	RELIABILITY_NO_FAULT_DETECTED     BACNET_RELIABILITY = 0
...
type BACNET_RELIABILITY = uint32

const (
	EVENT_CHANGE_OF_BITSTRING       EventType = 0
...
const (
	FILE_RECORD_ACCESS            FileAccess_METHOD = 0
	FILE_STREAM_ACCESS                              = 1
	FILE_RECORD_AND_STREAM_ACCESS                   = 2
)

type FileAccess_METHOD = uint32

const (
	MIN_LIFE_SAFETY_MODE                        LifeSafety_MODE = 0
...
type LifeSafety_MODE = uint32

const (
	LIFE_SAFETY_OP_NONE              LifeSafety_OPERATION = 0
...
type LifeSafety_OPERATION = uint32

const (
	MIN_LIFE_SAFETY_STATE              LifeSafety_STATE = 0
...
type LifeSafety_STATE = uint32

const (
	SILENCED_STATE_UNSILENCED       SilencedState = 0
...
type SilencedState = uint32

const (
	MAINTENANCE_NONE                     BACNET_MAINTENANCE = 0
...
type BACNET_MAINTENANCE = uint32

const (
	NOTIFY_ALARM            NotifyType = 0
	NOTIFY_EVENT                       = 1
...
const (
	SEGMENTATION_BOTH       BACNET_SEGMENTATION = 0
...
type BACNET_SEGMENTATION = uint8

const (
	VT_CLASS_DEFAULT         VtClass = 0
	VT_CLASS_ANSI_X34                = 1
	VT_CLASS_DEC_VT52                = 2
...
const (
	CHARACTER_ANSI_X34            CharacterString_ENCODING = 0
	CHARACTER_UTF8                                         = 0
	CHARACTER_MS_DBCS                                      = 1
...
type CharacterString_ENCODING = uint32

const (
	ApplicationTag_NULL                             ApplicationTag = 0
	ApplicationTag_BOOLEAN                                         = 1
	ApplicationTag_UNSIGNED_INT                                    = 2
	ApplicationTag_SIGNED_INT                                      = 3
	ApplicationTag_REAL                                            = 4
	ApplicationTag_DOUBLE                                          = 5
	ApplicationTag_OCTET_STRING                                    = 6
	ApplicationTag_CHARACTER_STRING                                = 7
	ApplicationTag_BIT_STRING                                      = 8
	ApplicationTag_ENUMERATED                                      = 9
	ApplicationTag_DATE                                            = 10
	ApplicationTag_TIME                                            = 11
	ApplicationTag_OBJECT_ID                                       = 12
	ApplicationTag_RESERVE1                                        = 13
	ApplicationTag_RESERVE2                                        = 14
	ApplicationTag_RESERVE3                                        = 15
	MAX_ApplicationTag                                             = 16
	ApplicationTag_EMPTYLIST                                       = 17
	ApplicationTag_WEEKNDAY                                        = 18
	ApplicationTag_DATERANGE                                       = 19
	ApplicationTag_DATETIME                                        = 20
	ApplicationTag_TIMESTAMP                                       = 21
	ApplicationTag_ERROR                                           = 22
	ApplicationTag_DEVICE_OBJECT_PROPERTY_REFERENCE                = 23
	ApplicationTag_DEVICE_OBJECT_REFERENCE                         = 24
	ApplicationTag_OBJECT_PROPERTY_REFERENCE                       = 25
	ApplicationTag_DESTINATION                                     = 26
	ApplicationTag_RECIPIENT                                       = 27
	ApplicationTag_COV_SUBSCRIPTION                                = 28
	ApplicationTag_CALENDAR_ENTRY                                  = 29
	ApplicationTag_WEEKLY_SCHEDULE                                 = 30
	ApplicationTag_SPECIAL_EVENT                                   = 31
	ApplicationTag_READ_ACCESS_SPECIFICATION                       = 32
	ApplicationTag_LIGHTING_COMMAND                                = 33
)

type ApplicationTag = uint32

const (
	PDU_TYPE_CONFIRMED_SERVICE_REQUEST   PduType = 0
	PDU_TYPE_UNCONFIRMED_SERVICE_REQUEST         = 16
	PDU_TYPE_SIMPLE_ACK                          = 32
	PDU_TYPE_COMPLEX_ACK                         = 48
	PDU_TYPE_SEGMENT_ACK                         = 64
	PDU_TYPE_ERROR                               = 80
	PDU_TYPE_REJECT                              = 96
	PDU_TYPE_ABORT                               = 112
)
...
const (
	SERVICE_CONFIRMED_ACKNOWLEDGE_ALARM            ConfirmedService = 0
...
const (
	...
	MAX_UnconfirmedService                                          = 11
)

type UnconfirmedService = uint8

const (
	SERVICE_SUPPORTED_ACKNOWLEDGE_ALARM              ServicesSupported = 0
...
type ServicesSupported = uint32

const (
	BVLC_RESULT                             BvlcFunction = 0
...
const (
	BVLC_RESULT_SUCCESSFUL_COMPLETION                  BvlcResult = 0
	BVLC_RESULT_WRITE_BROADCAST_DISTRIBUTION_TABLE_NAK            = 16
	BVLC_RESULT_READ_BROADCAST_DISTRIBUTION_TABLE_NAK             = 32
	BVLC_RESULT_REGISTER_FOREIGN_DEVICE_NAK                       = 48
	BVLC_RESULT_READ_FOREIGN_DEVICE_TABLE_NAK                     = 64
	BVLC_RESULT_DELETE_FOREIGN_DEVICE_TABLE_ENTRY_NAK             = 80
	BVLC_RESULT_DISTRIBUTE_BROADCAST_TO_NETWORK_NAK               = 96
)

type BvlcResult = uint32

const (
	STATUS_FLAG_IN_ALARM       StatusFlags = 0
	STATUS_FLAG_FAULT                      = 1
...
const (
	LOG_STATUS_LOG_DISABLED    LogStatus = 0
	LOG_STATUS_BUFFER_PURGED             = 1
	LOG_STATUS_LOG_INTERRUPTED           = 2
)

type LogStatus = uint32

const (
	LOGGING_TYPE_POLLED    LoggingType = 0
	LOGGING_TYPE_COV                   = 1
	LOGGING_TYPE_TRIGGERED             = 2
)

type LoggingType = uint32

const (
	ACKNOWLEDGMENT_FILTER_ALL       AcknowledgmentFilter = 0
	ACKNOWLEDGMENT_FILTER_ACKED                          = 1
	ACKNOWLEDGMENT_FILTER_NOT_ACKED                      = 2
)

type AcknowledgmentFilter = uint32

const (
	EVENT_STATE_FILTER_OFFNORMAL EventState_FILTER = 0
...
type EventState_FILTER = uint32

const (
	SELECTION_LOGIC_AND SelectionLogic = 0
...
const (
	RELATION_SPECIFIER_EQUAL                 RelationSpecifier = 0
...
const (
	COMMUNICATION_ENABLE             CommunicationEnable_DISABLE = 0
	COMMUNICATION_DISABLE                                        = 1
	COMMUNICATION_DISABLE_INITIATION                             = 2
	MAX_CommunicationEnable_DISABLE                              = 3
)

type CommunicationEnable_DISABLE = uint32

const (
	MESSAGE_PRIORITY_NORMAL             MessagePriority = 0
...
const (
	NETWORK_MESSAGE_WHO_IS_ROUTER_TO_NETWORK         NetworkMessageType = 0
...
const (
	REINITIALIZED_STATE_COLD_START    ReinitializedState_OF_DEVICE = 0
...
type ReinitializedState_OF_DEVICE = uint32

const (
	ABORT_REASON_OTHER                             AbortReason = 0
...
const (
	REJECT_REASON_OTHER                       RejectReason = 0
...
const (
	ERROR_CLASS_DEVICE            ErrorClass = 0
...
const (
	...
	ReinitStartbackup                         = 2
	ReinitEndbackup                           = 3
	ReinitStartrestore                        = 4
	ReinitEndrestore                          = 5
	ReinitAbortrestore                        = 6
	MAX_ReinitializedState                    = 7
	ReinitIdle                                = 255
)

type ReinitializedState = uint32
type BACnetNodeType uint32

const (
	NodeUnknown        BACnetNodeType = 0
	NodeSystem                        = 1
	NodeNetwork                       = 2
	NodeDevice                        = 3
	NodeOrganizational                = 4
	NodeArea                          = 5
	NodeEquipment                     = 6
	NodePoint                         = 7
	NodeCollection                    = 8
...
type BACnetShedState uint32

const (
	ShedInactive        BACnetShedState = 0
	ShedRequest_PENDING                 = 1
	ShedCompliant                       = 2
	ShedNon_COMPLIANT                   = 3
)

type ShedState uint32
type BACnetLightingOperation uint32

const (
	LightsNone              BACnetLightingOperation = 0
	LightsFade_TO                                   = 1
	LightsRamp_TO                                   = 2
	LightsStep_UP                                   = 3
	LightsStep_DOWN                                 = 4
	...
	LightsWarn                                      = 7
	LightsWarn_OFF                                  = 8
	LightsWarn_RELINQUISH                           = 9
	LightsStop                                      = 10
	MAX_LightingOperation                           = 11
	LightsProprietary_FIRST                         = 256
	LightsProprietary_LAST                          = 65535
)

type LightingOperation uint32
type BACnetLightingInProgress uint32

const (
	LightingIdle            BACnetLightingInProgress = 0
	LightingFade_ACTIVE                              = 1
	LightingRamp_ACTIVE                              = 2
	LightingNot_CONTROLLED                           = 3
	LightingOther                                    = 4
	MAX_LightingIn_PROGRESS                          = 5
)

type LightingIn_PROGRESS uint32
type BACnetLightingTransition uint32

const (
	LightingTransition_IDLE              BACnetLightingTransition = 0
	LightingTransition_FADE                                       = 1
	LightingTransition_RAMP                                       = 2
	MAX_LightingTransition                                        = 3
	LightingTransition_PROPRIETARY_FIRST                          = 64
	LightingTransition_PROPRIETARY_LAST                           = 255
)

type LightingTransition uint32
type BACnetDaysOfWeek uint32

const (
	DaysOf_WEEK_MONDAY    BACnetDaysOfWeek = 0
	DaysOf_WEEK_TUESDAY                    = 1
	DaysOf_WEEK_WEDNESDAY                  = 2
	DaysOf_WEEK_THURSDAY                   = 3
	DaysOf_WEEK_FRIDAY                     = 4
	DaysOf_WEEK_SATURDAY                   = 5
	DaysOf_WEEK_SUNDAY                     = 6
	MAX_DaysOf_WEEK                        = 7
)

type DaysOf_WEEK uint32
type BACnetEventTransitionBits uint32

const (
	TRANSITION_TO_OFFNORMAL BACnetEventTransitionBits = 0
	TRANSITION_TO_FAULT                               = 1
	TRANSITION_TO_NORMAL                              = 2
	MAX_EventTransition                               = 3
)

type EventTransition_BITS uint32
type BACnetEventTransitionMask uint32

const (
	TRANSITION_TO_OFFNORMAL_MASKED BACnetEventTransitionMask = 1
	TRANSITION_TO_FAULT_MASKED                               = 2
	TRANSITION_TO_NORMAL_MASKED                              = 4
)

type EventTransition_MASK uint32

const (
	DOOR_ALARM_STATE_NORMAL             DoorAlarm_STATE = 0
...
type DoorAlarm_STATE = uint32

const (
	DOOR_SECURED_STATUS_SECURED   DoorSecured_STATUS = 0
	DOOR_SECURED_STATUS_UNSECURED                    = 1
	DOOR_SECURED_STATUS_UNKNOWN                      = 2
)

type DoorSecured_STATUS = uint32

const (
	DOOR_STATUS_CLOSED     DoorStatus = 0
...
const (
	DOOR_VALUE_LOCK                  DoorValue = 0
	DOOR_VALUE_UNLOCK                          = 1
	DOOR_VALUE_PULSE_UNLOCK                    = 2
	DOOR_VALUE_EXTENDED_PULSE_UNLOCK           = 3
)

type DoorValue = uint32

const (
	LOCK_STATUS_LOCKED     LockStatus = 0
...
const (
	ACCESS_EVENT_NONE                                   AccessEvent = 0
...
type AccessEvent = uint32

const (
	AUTHENTICATION_STATUS_NOT_READY                         AuthenticationStatus = 0
...
const (
	AUTHORIZATION_MODE_AUTHORIZE             AuthorizationMode = 0
...
type AuthorizationMode = uint32

const (
	ACCESS_PASSBACK_MODE_PASSBACK_OFF  AccessPassback_MODE = 0
	ACCESS_PASSBACK_MODE_HARD_PASSBACK                     = 1
	ACCESS_PASSBACK_MODE_SOFT_PASSBACK                     = 2
)

type AccessPassback_MODE = uint32

const (
	ACCESS_ZONE_OCCUPANCY_STATE_NORMAL            AccessZone_OCCUPANCY_STATE = 0
...
type AccessZone_OCCUPANCY_STATE = uint32

const (
	ACCESS_USER_TYPE_ASSET  AccessUser_TYPE = 0
	ACCESS_USER_TYPE_GROUP                  = 1
	ACCESS_USER_TYPE_PERSON                 = 2
)

type AccessUser_TYPE = uint32

const (
	ACCESS_AUTHENTICATION_FACTOR_DISABLE_NONE               AccessAuthentication_FACTOR_DISABLE = 0
...
type AccessAuthentication_FACTOR_DISABLE = uint32

const (
	AUTHORIZATION_EXEMPTION_PASSBACK            AuthorizationExemption = 0
...
type AuthorizationExemption = uint32

const (
	NETWORK_REJECT_UNKNOWN_ERROR        NetworkReject_REASONS = 0
	...
	NETWORK_REJECT_REASON_INVALID                             = 7
)

type NetworkReject_REASONS = uint32
type BACnetWriteStatus uint32

const (
	WriteStatus_IDLE        BACnetWriteStatus = 0
	WriteStatus_IN_PROGRESS                   = 1
	WriteStatus_SUCCESSFUL                    = 2
	WriteStatus_FAILED                        = 3
)

type WriteStatus uint32

const (
	PORT_TYPE_ETHERNET   PortType = 0
	PORT_TYPE_ARCNET              = 1
	PORT_TYPE_MSTP                = 2
	PORT_TYPE_PTP                 = 3
	PORT_TYPE_LONTALK             = 4
...
const (
	PORT_QUALITY_UNKNOWN            PortQuality = 0
	PORT_QUALITY_LEARNED                        = 1
	PORT_QUALITY_LEARNED_CONFIGURED             = 2
	PORT_QUALITY_CONFIGURED                     = 3
)

type PortQuality = uint32

const (
	PORT_COMMAND_IDLE                    PortCommand = 0
	...
	PORT_COMMAND_PROPRIETARY_MIN                     = 128
	PORT_COMMAND_PROPRIETARY_MAX                     = 255
)

type PortCommand = uint32

const (
	SecurityLevel_INCAPABLE            SecurityLevel = 0
	SecurityLevel_PLAIN                              = 1
	SecurityLevel_SIGNED                             = 2
	SecurityLevel_ENCRYPTED                          = 3
	SecurityLevel_SIGNED_END_TO_END                  = 4
	SecurityLevel_ENCRYPTED_END_TO_END               = 5
)

type SecurityLevel = uint32

const (
	SecurityPolicy_PLAIN_NOT_TRUSTED SecurityPolicy = 0
	SecurityPolicy_PLAIN_TRUSTED                    = 1
	SecurityPolicy_SIGNED_TRUSTED                   = 2
	SecurityPolicy_ENCRYPTED_TRUSTED                = 3
)

type SecurityPolicy = uint32

const (
	KIA_AES_MD5                      KeyIdentifier_ALGORITHM = 0
	KIA_AES_SHA256                                           = 1
	KIA_MAX_KEY_IDENTIFIER_ALGORITHM                         = 255
)

type KeyIdentifier_ALGORITHM = uint32

const (
	KIKN_NOT_USED                      KeyIdentifier_KEY_NUMBER = 0
...
type KeyIdentifier_KEY_NUMBER = uint32

const (
	SEC_RESP_SUCCESS                        SecurityResponse_CODE = 0
...
type SecurityResponse_CODE = uint32

const (
	ACCESS_CREDENTIAL_DISABLE_NONE            AccessCredential_DISABLE = 0
	ACCESS_CREDENTIAL_DISABLE_DISABLE                                  = 1
	ACCESS_CREDENTIAL_DISABLE_DISABLE_MANUAL                           = 2
	ACCESS_CREDENTIAL_DISABLE_DISABLE_LOCKOUT                          = 3
)

type AccessCredential_DISABLE = uint32

const (
	ACCESS_CREDENTIAL_DISABLE_REASON_DISABLED                    AccessCredential_DISABLE_REASON = 0
...
type AccessCredential_DISABLE_REASON = uint32

const (
	AUTHENTICATION_FACTOR_TYPE_UNDEFINED            AuthenticationfactorType = 0
...
type AuthenticationfactorType = uint32

const (
	NETWORK_TYPE_ETHERNET        NetworkType = 0
...
const MAX_MAC_LEN = 7
const MAX_NPDU = 1 + 1 + 2 + 1 + MAX_MAC_LEN + 2 + 1 + MAX_MAC_LEN + 1 + 1 + 2
const MAX_APDU = 1476
const MAX_PDU = MAX_APDU + MAX_NPDU
const MAX_HEADER = 1 + 1 + 2
const MAX_MPDU = MAX_HEADER + MAX_PDU
const MAX_BITSTRING_BYTES = 15
const MAX_CHARACTER_STRING_BYTES = MAX_APDU - 6
const MAX_OCTET_STRING_BYTES = MAX_APDU - 6

type OctetStringBytes = [MAX_OCTET_STRING_BYTES]byte
type BitStringBytes = [MAX_BITSTRING_BYTES]byte
type MaxCharacterStringBytes = [MAX_CHARACTER_STRING_BYTES]byte
...
type LightingCommand struct {
	...
	use_fade_time      bool
	use_priority       bool
	target_level       float32
	ramp_rate          float32
	step_increment     float32
	fade_time          uint32
	priority           uint8
}
